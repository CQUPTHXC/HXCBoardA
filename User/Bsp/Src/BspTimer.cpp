...
static const char* ClockDivisionToString(uint32_t div)
{
  switch (div)
  {
  case TIM_CLOCKDIVISION_DIV1: return "DIV1";
  case TIM_CLOCKDIVISION_DIV2: return "DIV2";
  case TIM_CLOCKDIVISION_DIV4: return "DIV4";
  default:                     return "UNKNOWN";
  }
}
...
BspResult<bool> Timer::ShowInfo() const
{
  ...
  Printf("===== %s Info =====\n"
        ...
        PSC,
        ARR,
        CounterModeToString(handle->Init.CounterMode),
        handle->Init.AutoReloadPreload == TIM_AUTORELOAD_PRELOAD_ENABLE ? "ENABLE" : "DISABLE",
